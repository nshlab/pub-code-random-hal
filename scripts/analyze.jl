...
### Small Comparison ###
filenames = [
    "3_small_comparison-combined-metrics (12).csv"
]
...
filenames = [
    "3_small_comparison-combined-preds (12).csv"
]
...
### Large Comparison ###
filenames = [
    "4_large_randomhal-combined-metrics (12).csv"
]
...
filenames = [
    "4_large_randomhal-combined-preds (12).csv"
]
